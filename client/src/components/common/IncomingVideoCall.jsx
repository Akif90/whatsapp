...
function IncomingVideoCall() {
  ...
  return (
    <div
      className="h-24 w-80 fixed bottom-8 mb-0 right-6 z-50 rounded-sm flex
  gap-5 items-center justify-start p-4 bg-conversation-panel-background text-white drop-shadow-2xl
    ...
    >
      ...
      <div>
        ...
        <div className="flex gap-2 mt-2 ">
          <button
            className="bg-red-500 p-1 px-3 text-sm rouneded-full"
            onClick={rejectCall}
          >
            Reject
          </button>
          <button
            className="bg-green-500 p-1 px-3 text-sm rouneded-full"
            onClick={acceptCall}
          >
            Accept
          </button>
