...
function CapturePhoto({setImage, setShowCapturePhoto}) {
  ...
  return (
    <div
      className="absolute h-4/6 w-2/6 top-1/4 left-1/3
     bg-gray-900 gap-3 rounded-lg pt-2 flex items-center justify-center"
    >
      <div className="flex flex-col gap-4 w-full justify-center items-center">
        ...
        <button
          className="h-16 w-16 cursor-pointer bg-white rounded-full 
        border-8 border-teal-light p-2 mb-10"
