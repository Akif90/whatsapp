...
function SearchMessages() {
  ...
  return (
    <div
      className="border-x-conversation-border border-l w-full bg-panel-header-background
    flex flex-col max-h-screen z-10
    "
    >
            ...
            {searchedMessages.map((message) => {
              return (
                <div
                 ...
                 hover:bg-background-default-hover w-full px-5 border-b-[0.1px] border-secondary
                 py-5 "
                >
